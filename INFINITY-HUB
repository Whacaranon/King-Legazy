...
if syn then
    ...
    _G.DistanceMob = 2
    Main:AddSliderRight("Distance",1,100,2,function(value)
            ...
            if _G.AutoFarm then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Quest.QuestBoard.Visible == false then
                        if not game:GetService("Workspace").AntiTPNPC:FindFirstChild("QuestLvl"..CheckQuest()) then
                            TP(game:GetService("ReplicatedStorage").MAP["QuestLvl"..CheckQuest()].HumanoidRootPart.CFrame * CFrame.new(0,0,0))
                        else 
                            TP(game:GetService("Workspace").AntiTPNPC["QuestLvl"..CheckQuest()].HumanoidRootPart.CFrame * CFrame.new(0,0,0))
                        end
                        game:GetService'VirtualUser':Button1Down(Vector2.new(1,1));
					game:GetService'VirtualUser':Button1Up(Vector2.new(1,1));
                        for i,v in pairs(game.Players.LocalPlayer.PlayerGui:GetDescendants()) do
                    ...
                    elseif game:GetService("Players").LocalPlayer.PlayerGui.Quest.QuestBoard.Visible == true then
                        Mobs = string.sub(game:GetService("Players").LocalPlayer.PlayerGui.Quest.QuestBoard.QuestCount.Text,5,#game:GetService("Players").LocalPlayer.PlayerGui.Quest.QuestBoard.QuestCount.Text);
                        if game:GetService("Workspace").Monster.Mon:FindFirstChild(Mobs) then
                            for i,v in pairs(game:GetService("Workspace").Monster.Mon:GetChildren()) do
                                if v.Name == Mobs and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                        repeat task.wait()
                                            AutoHaki()
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Functions"):WaitForChild("SkillAction"):InvokeServer("FS_".._G.SelectWeapon.."_M1")
                                        ...
                                        until not v.Parent or v.Humanoid.Health <= 0 or _G.AutoFarm == false or game:GetService("Players").LocalPlayer.PlayerGui.Quest.QuestBoard.Visible == false
                                            ...
                                            if not game:GetService("Workspace").AntiTPNPC:FindFirstChild("QuestLvl"..CheckQuest()) then
                                                TP(game:GetService("ReplicatedStorage").MAP["QuestLvl"..CheckQuest()].HumanoidRootPart.CFrame * CFrame.new(0,500,0))
                                            else 
                                                TP(game:GetService("Workspace").AntiTPNPC["QuestLvl"..CheckQuest()].HumanoidRootPart.CFrame * CFrame.new(0,500,0))
                                            end
                                        end
                                    end
                                end
                            
                        elseif game:GetService("Workspace").Monster.Boss:FindFirstChild(Mobs) then
		...
		if _G.AutoFarm then
			pcall(function()
				...
				if game.Players.LocalPlayer.PlayerGui.Quest.QuestBoard.Visible == false then
					if not game:GetService("Workspace").AllNPC:FindFirstChild("QuestLvl"..CheckQuest()) then
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage").MAP["QuestLvl"..CheckQuest()].HumanoidRootPart.CFrame * CFrame.new(0,0,-3);
					else 
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").AllNPC["QuestLvl"..CheckQuest()].HumanoidRootPart.CFrame * CFrame.new(0,0,-3);
					end;
					game:GetService'VirtualUser':Button1Down(Vector2.new(1,1));
					game:GetService'VirtualUser':Button1Up(Vector2.new(1,1));
					for i,v in pairs(game.Players.LocalPlayer.PlayerGui:GetDescendants()) do
